...
#--full_train__gamma=0.9 --full_train__lr=0.001 --full_train__max_epoch=200 --labeled_percentate=0.04 --idx_model=1
#
#
...
#--full_train__gamma=0.9 --full_train__lr=0.001 --full_train__max_epoch=200 --labeled_percentate=0.04 --idx_model=2
