...
class UNet(nn.Module):
    ...
    def get_encoder_params(self):
        """
        This generator returns all the parameters of the encoder layers.
        """
        b = [self.enc5, self.enc4, self.enc3, self.enc2, self.enc1]
    ...
    def get_decoder_params(self):
        ...
        This generator returns all the parameters of the encoder layers.
        """
        b = [self.dec1, self.dec2, self.dec3, self.dec4, self.dec5]
    ...
    def optim_parameters(self, learning_rate):
        return [{'params': self.get_encoder_params(), 'lr': learning_rate / 4},
...
class SegNet(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        #for 1D images#
        # self.dec1._modules['0']= nn.Conv2d(1,64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)) # modified by Guille
